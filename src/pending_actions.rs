...
//! a 2-level match (wrapper → family). Phase 15 will split each family arm
//! into its own handler method (see ARCHITECTURE.md §3.1).
...
impl AppState {
    pub(crate) fn dispatch_pending_action(
        ...
        match action {
            PendingAction::Session(a) => match a {
            ...
            PendingAction::Drawer(a) => match a {
            ...
            PendingAction::Settings(a) => match a {
            ...
            PendingAction::Browser(a) => match a {
