...
impl DeepLink {
    ...
    pub(crate) fn to_url(&self) -> String {
        match self {
            ...
            DeepLink::File { project, session, path, line } => {
...
impl AppState {
    ...
    pub(crate) fn open_deep_link(&mut self, url: &str, window: &mut Window, cx: &mut Context<Self>) {
    ...
    pub(crate) fn navigate(&mut self, link: DeepLink, _window: &mut Window, cx: &mut Context<Self>) {
        match link {
