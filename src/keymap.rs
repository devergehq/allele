...
use crate::{
    CycleAttentionSession, OpenFilePaletteAction, OpenScratchPadAction, OpenSettings, Quit,
    ToggleDrawerAction, ToggleSidebarAction, ToggleTranscriptTabAction,
};
...
fn build_binding(
    ...
    match resolved {
        ...
        "text_input.select_to_home" => KeyBinding::new(keystroke, ti::SelectToHome, ctx),
        "text_input.select_to_end" => KeyBinding::new(keystroke, ti::SelectToEnd, ctx),
