...
use crate::{
    OpenScratchPadAction, OpenSettings, Quit, ToggleDrawerAction, ToggleRichMode,
    ToggleSidebarAction,
};
...
const DEPRECATED_ALIASES: &[(&str, &str)] = &[
    // ("compose.old_name", "compose.new_name"),
];
...
fn build_binding(
    ...
    match resolved {
        ...
        "allele.toggle_rich_mode" => KeyBinding::new(keystroke, ToggleRichMode, ctx),
